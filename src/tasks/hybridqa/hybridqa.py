...
_WIKI_TABLES_GIT_ARCHIVE_URL = "https://github.com/wenhuchen/WikiTables-WithLinks/archive/f4ed68e54e25c495f63d309de0b89c0f97b3c508.zip"

_QA_DATA_BASE_URL = (
    "https://raw.githubusercontent.com/wenhuchen/HybridQA/master/released_data"
)
_URLS = {
...
class HybridQa(datasets.GeneratorBasedBuilder):
                    ...
                    datasets.features.Sequence(
                        {
                            ...
                            "urls": datasets.features.Sequence(
                                {
                                    "url": datasets.Value("string"),
    ...
    def _split_generators(self, dl_manager):
        ...
        repo_path = os.path.join(
            extracted_path,
            "WikiTables-WithLinks-f4ed68e54e25c495f63d309de0b89c0f97b3c508",
        )
        ...
        for example in examples:
            ...
            for row in table["data"]:
                ...
                for col in row:
                    ...
                    urls = col[1]
                    new_row["urls"] = [
                        {"url": url, "summary": url_data[url]} for url in urls
                    ]
            ...
            example["answer_text"] = (
                example.pop("answer-text") if "answer-text" in example else ""
            )
            example["table"] = table
