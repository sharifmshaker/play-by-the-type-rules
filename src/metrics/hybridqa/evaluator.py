...
import collections
import string
from src.tasks.dataset_utils import str_normalize
from src.wikitq_evaluator import to_value_list, check_denotation
...
if __name__ == "__main__":
    ...
    evaluator.evaluate(preds=["1"], golds=[{"answer_text": "1", "id": 0}])
    print()
